var CPlants = NewO({
    ...
    CanGrow: function (c, b, d) {
      var a = b + "_" + d;
      return oGd.$LF[b] == 1
        ? !(d < 1 || d > 9 || oGd.$Crater[a] || oGd.$Tombstones[a] || c[1])
        : c[0] && !c[1];
    },
  ...
  oSunFlower = InheritO(CPlants, {
    ...
    PrivateBirth: function (a) {
      oSym.addTask(
        ...
        function (d, c, b) {
          $P[d] &&
            (AppearSun(Math.floor(c + Math.random() * 41), b, 25, 0),
            oSym.addTask(2400, arguments.callee, [d, c, b]));
        },
      ...
      oSym.addTask(
        ...
        function (f, d, c, e) {
          $P[f] &&
            (AppearSun(d, e, 25, 0),
            AppearSun(c, e, 25, 0),
            oSym.addTask(2400, arguments.callee, [f, d, c, e]));
        },
  ...
  oLilyPad = InheritO(oFlowerPot, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/LilyPadG.png",
  ...
  oPotatoMine = InheritO(CPlants, {
    ...
    CanGrow: function (d, c, e) {
      ...
      return a % 2
        ? a < 3
          ? !(e < 1 || e > 9 || d[1] || oGd.$Crater[b] || oGd.$Tombstones[b])
          : d[0] && !d[1]
        : 0;
    },
    PicArr: [
        ...
        function (c) {
          ...
          b &&
            ...
            (b.getHurt = function (g, e, d) {
              ...
              e > 2
                ? (f.HP -= d) < 1 && f.Die()
                : f.NormalAttack(f.pixelLeft, f.pixelLeft + f.width, f.R);
            }));
        },
        [a.id]
      );
      ...
      c.length
        ? ((h = !a.WalkDirection ? -5 : 5),
          ...
          SetStyle(b, {
            ...
            top:
              (a.pixelTop =
                GetY((k = c[Math.floor(Math.random() * c.length)])) -
                a.height) + "px",
  ...
  oSquash = InheritO(CPlants, {
    ...
    TriggerCheck: function (c, b, a) {
      c.beAttacked &&
        c.Altitude > -1 &&
        c.Altitude < 2 &&
        (oT.$[this.R].splice(a, 1), this.NormalAttack(c));
    },
  ...
  oCoffeeBean = InheritO(CPlants, {
    ...
    BirthStyle: function (c, d, b, a) {
      b.childNodes[1].src =
        "images/Plants/CoffeeBean/CoffeeBeanEat.gif" + $Random + Math.random();
      EditEle(b, { id: d }, a, EDAll);
    },
    PrivateBirth: function (a) {
      oSym.addTask(
      ...
      oSym.addTask(
        ...
        function (b) {
          ...
          if (d) {
            c = (f = d.ArZ).length;
            while (c--) {
              (!(e = $Z[f[c]]) || Math.abs(e.ZX - d.MX) > 120) &&
                f.splice(c, 1);
            }
            f.length
              ? d.CryCheck(b)
