      ...
      ((a = function () {}).prototype = {
        ...
        Init: function (g, j, e, d) {
          var c = 0,
            ...
            f = [];
          j.AttackedRX =
            (j.X = (j.ZX = j.AttackedLX = g) - j.beAttackedPointL) +
            j.beAttackedPointR;
          while (--d) {
        ...
        CustomBirth: function (j, c, d) {
          ...
          g.AttackedRX =
            (g.X = (g.ZX = g.AttackedLX = GetX(c) - (k - m) * 0.5) - m) + k;
          g.R = j;
          g.pixelTop = h;
          g.zIndex = l;
        ...
        Die: function (d) {
          var e = this,
            ...
            c = $(f);
          !d
            ? ((c.childNodes[1].src = e.PicArr[e.DieGif] + Math.random()),
              oSym.addTask(250, ClearChild, [c]))
            : d < 2
            ? ((c.childNodes[1].src = e.PicArr[e.BoomDieGif] + Math.random()),
              oSym.addTask(300, ClearChild, [c]))
            : ClearChild(c);
          e.HP = 0;
          delete $Z[f];
          oP.MonPrgs();
        ...
        NormalAttack: function (d, c) {
          ...
          e &&
            !e.isAttacking &&
            ((e.isAttacking = 1),
            ($(d).childNodes[1].src = e.PicArr[e.AttackGif]));
          oSym.addTask(
            100,
            function (g, f) {
              var j = $Z[g],
              ...
              j &&
                ...
                ((h = $P[f]) &&
                  h.getHurt(
                    j,
                    j.AKind,
                    !j.FreeSlowTime ? j.Attack : Math.round(j.Attack * 0.5)
                  ),
                j.JudgeAttack());
            },
            [d, c]
              ...
              e.canSlow &&
                ...
                oSym.addTask(
                  ...
                  function (o, s, r) {
                    (r = $Z[o]) &&
                      s == r.FreeSlowTime &&
                      ((r.FreeSlowTime = ""), (r.Speed = r.OSpeed));
                  },
            ...
            default:
              ...
              if (e.canSputtering) {
                ...
                for (
                  h = f.length;
                  h--;
                  f[h].canSputtering && f[h].getHurt(1, 0, 13, 0, 0, 0, 0)
                ) {}
              }
          }
      ...
      switch (true) {
        ...
        default:
          ...
          $(b).childNodes[1].src =
            e.PicArr[
              [
                (e.NormalGif = e.OrnLostNormalGif),
                (e.AttackGif = e.OrnLostAttackGif),
              ][f]
            ];
      }
      switch (n) {
          ...
          e.canSlow &&
            ...
            oSym.addTask(
              ...
              function (o, r, q) {
                (q = $Z[o]) &&
                  r == q.FreeSlowTime &&
                  ((q.FreeSlowTime = ""), (q.Speed = q.OSpeed));
              },
              [b, (e.FreeSlowTime = oSym.Now)]
            ));
          break;
        default:
          ...
          if (e.canSputtering) {
            ...
            for (
              i = ar.length;
              i--;
              ar[i].canSputtering && ar[i].getHurt(1, 0, 13, 0, 0, 0, 0)
            ) {}
          }
      }
      SetAlpha($(b).childNodes[1], 50, 0.5);
        ...
        function (l, j, h, k, r) {
          ...
          q &&
            ((m = $P[j]) && m.Stature > 0
              ? ((q.AttackedRX =
                  (q.X =
                    (q.AttackedLX = q.ZX = n = m.AttackedRX) -
                    q.beAttackedPointL) + q.beAttackedPointR),
              ...
              : ((q.ZX = q.AttackedLX =
                  (q.X = (q.AttackedRX = f) - q.beAttackedPointR) +
                  q.beAttackedPointL),
                SetStyle(h, { left: q.X + "px" }),
                (r.src =
              ...
              d.canSlow &&
                ...
                oSym.addTask(
                  ...
                  function (m, o, n) {
                    (n = $Z[m]) &&
                      o == n.FreeSlowTime &&
                      ((n.FreeSlowTime = ""), (n.Speed = n.OSpeed));
                  },
